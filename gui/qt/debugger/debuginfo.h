...
public:
    ...
    public:
        ...
        void child(_Addr __low, _Addr __high, _Scope &__child) noexcept {
        ...
        constexpr const _Scope &function() const noexcept {
            return is_function() ? *this : _M_parent ? _M_parent.function() : _S_null;
        }
        constexpr const _Die &entry() const noexcept { return _M_entry; }
        const _Scope &child(_Addr __addr) const noexcept;
